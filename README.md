...
> A growing collection of Python exercises — general practice projects alongside Python re-implementations of problems I've solved in my [C++ course](https://github.com/YOUR_USERNAME/learn-cpp-educative).
